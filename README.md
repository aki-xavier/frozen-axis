...
📄 **Paper: English LaTeX source (official JMLR jmlr2e style); run `./build.sh` to produce the PDF**
...
| `jmlr2e.sty` | Official JMLR style file (do not modify) |
...
| Definition 2 (Mode A/B) | `IsModeA`, `IsModeB`, `DependsOnlyOn` |
