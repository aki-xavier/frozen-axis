...
📄 **Paper: [paper.pdf](paper.pdf) (55 pages, released); LaTeX source in the official JMLR jmlr2e style, rebuild with `./build.sh`**
...
| `paper.pdf` | Released PDF (55 pages) built from `paper.tex`, committed at the repository root |
