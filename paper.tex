...
\hypersetup{hidelinks,
  ...
  pdfsubject={Open inversion tasks; completeness; formal falsification; fixed-memory component; decision axis; open set},
  pdfkeywords={open inversion tasks, completeness, formal falsification, fixed-memory component, decision axis, open set}}
...
\begin{keywords}
  open inversion tasks; completeness; formal falsification; fixed-memory component; decision axis; open set
\end{keywords}
...
Lemma 2 therefore does not nail the rule's position inside a single generative objective; it converges the question onto the source: the form is free, the source is not. The only question left is ``where the rule's values come from'', which the open-set criterion and the non-freezability criterion answer.
...
\hline
Criterion P3 (open set) & \texttt{P3}, \texttt{p3\_implies\_p1} & A\\
\hline
